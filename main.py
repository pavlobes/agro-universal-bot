...
def get_diff_text(old_df, new_df):
    try:
        ...
        greeting = (
            "Доброго дня!<br>"
            "<b>ТОВ Хиллс Трейд</b><br>"
            "<u>Оновлення цін на " + today + ":</u><br><br>"
        )

        contact_info = (
            "<br>Можлива доставка у ваш регіон або склад, за деталями звертайтесь до менеджера.<br><br>"
            "Контакти менеджерів:<br>"
            "📞 Інна — +38 (095) 502-22-87 • @kipish_maker2<br>"
            "📞 Павло — +38 (067) 519-36-86 • @Pawa_fbc<br>"
            "📧 office@hillstrade.com.ua"
        )

        return greeting + "<br>".join(lines) + "<br>&nbsp;<br>" + contact_info
